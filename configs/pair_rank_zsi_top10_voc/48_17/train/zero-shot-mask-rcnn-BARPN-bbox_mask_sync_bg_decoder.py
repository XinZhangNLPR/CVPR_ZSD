...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_rank=dict(
            type='PaiRankLoss', loss_weight=1.0,topk=10),
        loss_semantic=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0),
...
log_level = 'INFO'
work_dir = './work_dirs/pair_rank_zsi_top10_voc/48_17'
load_from = "/data/AdapterZSD/work_dirs/pair_rank_zsi_top10/48_17/epoch_12.pth"#None
resume_from = None
workflow = [('train', 1)]
